...
const Personalidades = () => {
    return (
        <div>
            <Navbar />
            <div className="w-full flex flex-row gap-10 p-10  max-h-screen overflow-hidden">
            ...
            <div className='relative w-full min-h-screen text-white bg-gray-900 p-10 md:p-40 lg:p-60'>
                ...
                <section className='mb-20 flex flex-col gap-6'>
                    ...
                    <Link type="button" href="/" className='bg-sky-500 text-white text-2xl font-bold py-4 mt-5 flex justify-center hover:bg-sky-600 rounded-xl'>Fazer quiz</Link>
                </section>
            </div>
        </div>
    );
