...
const MultiStepForm = () => {
    ...
    const summaries = {
        Águia: {
            ...
            image: <img src={"../../assets/aguia.svg"} alt="aguia" className=' w-20' />
        },
        Gato: {
            ...
            image: <img src={"../../assets/gato.svg"} alt="gato" className=' w-20' />
        },
        Lobo: {
            ...
            image: <img src={"../../assets/Lobo.svg"} alt="lobo" className=' w-20' />
        },
        Tubarão: {
            ...
            image: <img src={"../../assets/tuba.svg"} alt="tubarao" className=' w-20' />
        }
    }
                ...
                {page === questions.length + 2 && (
                    <div ref={chartRef} className='w-full px-5 md:px-20 py-12 grid xl:grid-cols-2 gap-5 grid-cols-1 bg-slate-900 border border-sky-500/30 rounded-xl'>
                        <div>
                            ...
                            <Link href="/personalidades" className="bg-slate-950/20 border border-white/50 rounded-md flex px-5 py-2 gap-20 items-center hover:bg-gray-600 mt-10">
